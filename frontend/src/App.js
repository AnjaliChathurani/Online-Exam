...
function App() {
  return (
    <Switch>
      ...
      <Route path="/StudentSingleExamView" exact>
        <StudentSingleExamView />
      </Route>
      <Route path="/TeacherMain" exact>
        <TeacherMain />
      </Route>
      <Route path="/TeacherSingle" exact>
        <TeacherSingle />
      </Route>
      <Route path="/ExamResult" exact>
        <ExamResult />
      </Route>
      <Route path="/MonitorExam" exact>
        <MonitorExam />
      </Route>
      <Route path="/StudentMainView" exact>
        {" "}
        <StudentMainView />{" "}
      </Route>
    </Switch>
